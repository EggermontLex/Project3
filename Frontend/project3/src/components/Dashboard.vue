    ...
    <div class="side_bar">
      ...
      <div class="side_bar_input">
        ...
        <div>
          ...
          <div class="date_time">
            <Input class="date_time_item"  label="Datum:" type="date"/> <!--v-model="fromDatum"-->
            <Input class="date_time_item"  label="Tijd:" type="time"/> <!--v-model="fromTijd"-->
          </div>
        </div>
        <div>
          <p class="subtitle">Tot</p>
          <div class="date_time">
            <Input class="date_time_item"  label="Datum:" type="date"/><!--v-model="intilDatum" -->
            <Input class="date_time_item"  label="Tijd:" type="time"/><!--v-model="intilTijd" -->
          </div>
        </div>
        <Button class="button" text="Zoek"/><!--@click.native="getLoginData"/>-->
      </div>
